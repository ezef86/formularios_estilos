...
const botonCambiarEstilosAleatorio = document.getElementById('botonCambiarEstilosAleatorio');
...
botonRecordarEstilos.addEventListener('click', () => {
  ...
  const styleSheetRelativePath = "./styles/" + currentStyleSheetHref.split('/').pop();
